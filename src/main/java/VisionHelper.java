...
public class VisionHelper {
  ...
  public static final int FOVpixelWidth = Main.imgWidth;
  ...
  public static final int FOVpixelHeight = Main.imgHeight;
  ...
  public static MatOfPoint getLargestContour(Mat mat) {
    Main.pipeline.process(mat);
    ArrayList<MatOfPoint> contours = Main.pipeline.filterContoursOutput();
    if(contours.size()>0)
      {int index = 0;
      int largestArea = 0;
